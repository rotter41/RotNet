...
document.getElementById("pridatRoutr").addEventListener("click", () => {
    ...
    bt1.addEventListener("click", () =>
    {
        IPaddressRouter[lokalniPoradi] = textbox.value
        console.log("Ip router" + lokalniPoradi + ": " + IPaddressRouter[lokalniPoradi])
        MaskPC[lokalniPoradi] = textbox2.value
        console.log("Mask pc" + lokalniPoradi + ": " + MaskPC[lokalniPoradi])
        switchConectRouter[lokalniPoradi] = SWconect.value
        console.log("Switch conect" + poradiRouter + ": " + switchConectRouter[lokalniPoradi])
    });
